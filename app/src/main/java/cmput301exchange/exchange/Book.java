...
public class Book implements Shareable, Comparable<Book>, Serializable {
    ...
    private ArrayList<String> photos = new ArrayList<>(); //List of the pictures. Be sure to use the photo's add method to ensure that the photos are under the size req.
    private String ISBN = "";
