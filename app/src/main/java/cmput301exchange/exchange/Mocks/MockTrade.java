...
public class MockTrade {
    ...
    public MockTrade(){
        ...
        sendTrade1.setTradePartner(new Person("friend1"));
        ...
        sendTrade2.setTradePartner(new Person("friend2"));
        userBooks.add(sharableBooks.get(0));
        ...
        acceptedTrade.setTradePartner(new Person("friend3"));
        ...
        declinedTrade.setTradePartner(new Person("friend4"));
        userBooks.add(sharableBooks.get(2));
        friendBooks.add(sharableBooks.get(3));
        ...
        counterTrade.setTradePartner(new Person("friend4"));
        userBooks.add(sharableBooks.get(1));
        friendBooks.add(sharableBooks.get(3));
