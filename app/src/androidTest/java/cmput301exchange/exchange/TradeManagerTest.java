...
public class TradeManagerTest extends ActivityInstrumentationTestCase2 {
    ...
    public void testAcceptOffer() {
        ...
        // now the tradeStatus should be 1; trade accepted
        int testTradeStatus = tradeManager0.getListPastTrade().get(0).getTradeStatus();
        assertEquals(testTradeStatus, 1);
    }
    ...
    public void testDeclineOffer() {
        ...
        tradeManager0.declineTrade(trade0, 1);
    ...
    public void testCounterTrade() {
        ...
        tradeManager0.declineTrade(trade0, 0);
